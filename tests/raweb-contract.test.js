...
import { readUserscript } from './helpers/harness.js';
...
describe('fixture provenance', () => {
  it('records which RAWeb revision the markup was copied from', () => {
  ...
  it('covers every snippet the tests below read', () => {
...
describe('layout', () => {
  it('only marks <main> with `with-sidebar` on sidebar pages', () => {
  ...
  it('renders /settings without a sidebar, so the script must not require the class', () => {
    expect(source('settingsPage')).toContain('withSidebar={false}');
    expect(script).not.toContain('main.with-sidebar article');
  });

  it('serves Inertia props from the #app data-page blob', () => {
...
describe('settings page', () => {
  it('groups the section cards into tab panels', () => {
  ...
  it('keeps the card and button classes the script mirrors', () => {
...
describe('game page', () => {
  it('exposes the sidebar and main roots by test id', () => {
  ...
  it('still renders the box art wrapper the ROM section anchors to', () => {
...
describe('achievement list items', () => {
  ...
  it('keeps the unlock rate paragraph the rarity badge parses', () => {
...
describe('comments', () => {
  it('keeps the highlighted-list wrapper and word-break body', () => {
...
describe('navbar', () => {
  it('keeps the dropdown/nav-item/nav-link structure', () => {
...
describe('user profile', () => {
  it('keeps the stat row markup the User Stats card scrapes', () => {
  ...
  it('keeps the "Last N Games Played" heading and its game list', () => {
  ...
  it('keeps the progression status rows and tallies', () => {
  ...
  it('keeps the Game Awards section id, counters and badge classes', () => {
...
describe('games list', () => {
  it('keeps the toolbar wrapper the Most Mastered tab attaches to', () => {
...
describe('legacy web API', () => {
  it.each(rawebApiEndpoints)('%s is still called by the script', (endpoint) => {
    expect(script).toContain(`${endpoint}.php`);
  });
});

describe('userscript hygiene', () => {
  it('never builds attribute names setAttribute would reject', () => {
    expect(script).not.toMatch(/setAttribute\(\s*['"]@/);
  });

  it('declares every host it fetches from in @connect', () => {
